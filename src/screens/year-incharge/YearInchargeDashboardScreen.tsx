...
const YearInchargeDashboardScreen = () => {
    ...
    const [yi, setYi] = useState<any>(null);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.hero}>
                    ...
                    <Text style={styles.name}>{yi?.name || 'Year Incharge'}</Text>
                    <Text style={styles.sub}>{yi?.department || ''}</Text>
                </View>
                <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Quick Actions</Text>
                    <View style={styles.grid}>
                        {[
                            { emoji: '📋', label: 'Pending Outpass', route: 'YIPendingOutpass' },
                            { emoji: '📑', label: 'Outpass List', route: 'YIOutpassList' },
                            { emoji: '👥', label: 'Student View', route: 'YIStudentView' },
                            { emoji: '👤', label: 'My Profile', route: 'YearInchargeProfile' },
                        ].map((a) => (
