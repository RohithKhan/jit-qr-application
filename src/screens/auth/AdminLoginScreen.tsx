    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                setTimeout(() => navigation.reset({ index: 0, routes: [{ name: 'Admin' }] }), 800);
            }
        } catch (error: any) {
            ...
            <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.inputGroup}>
                        ...
                        <TextInput style={styles.input} value={email} onChangeText={setEmail} placeholder="Admin Email" placeholderTextColor={COLORS.textLight} keyboardType="email-address" autoCapitalize="none" />
                    </View>
                    <View style={styles.inputGroup}>
                    ...
                    <TouchableOpacity style={[styles.btn, loading && styles.btnDisabled]} onPress={handleLogin} disabled={loading}>
                        {loading ? <ActivityIndicator color={COLORS.white} /> : <Text style={styles.btnText}>Sign In as Admin</Text>}
                    </TouchableOpacity>
                </View>
            </ScrollView>
        </SafeAreaView>
...
const styles = StyleSheet.create({
    ...
    eyeBtn: { padding: 12 },
    btn: { backgroundColor: COLORS.primary, paddingVertical: 16, borderRadius: 16, alignItems: 'center', marginTop: 12, ...SHADOWS.medium },
